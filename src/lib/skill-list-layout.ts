 ...
 * card takes its own height — a one-skill repository measures 95px, a
 * repository at its cap 179px — instead of being stretched to its neighbour. A
 ...
 * 179px — because the cap, not a one-skill repository, is what a grid row is
 * as tall as.
 */
export const REPO_CARD_SKELETON_CLASS = "h-[179px] rounded-xl";
