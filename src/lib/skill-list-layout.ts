 ...
 * repository at its cap 177px — instead of being stretched to its neighbour. A
 ...
 * 177px — because the cap, not a one-skill repository, is what a grid row is
 * as tall as.
 */
export const REPO_CARD_SKELETON_CLASS = "h-[177px] rounded-xl";
