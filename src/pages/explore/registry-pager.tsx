...
/**
 * The registry pages' shared pagination row: previous / numbered pages (with
 * ellipsis) / next — the current page number doubles as an editable jump box
 * — with the item count pinned to the right. The pager controls appear only
 * when there is more than one page, so the count survives single-page
 * searches. Absolute positioning keeps the pager centered regardless of how
 * wide the count or the page window gets.
 */
