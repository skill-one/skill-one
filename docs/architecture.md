...
| `src/components/app-sidebar.tsx` | Sidebar navigation — the store and the installed skills — plus their nav badges: 商店 counts the skills streamed in so far, 我的 skills the installed skill count |
